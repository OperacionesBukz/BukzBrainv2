...
export default function UploadStep({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Paso 2: Importar CMV completado */}
      <div>
        <h3 className="text-sm font-medium text-muted-foreground mb-3">
          Paso 2 — Importar CMV completado (con márgenes y costos)
        </h3>
        <FileUploadZone
          title="CMV completado"
          hint="Sube el Excel del CMV con las columnas de Margen, Descuento y Costo ya llenadas"
          accept=".xlsx,.xls"
          isLoaded={false}
